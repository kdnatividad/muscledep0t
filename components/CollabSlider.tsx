...
export default function CollabSlider() {
  ...
  return (
    <section
      className="relative overflow-hidden py-16 px-4 sm:px-8 md:px-12 lg:px-16"
          ...
          <div className="flex flex-col gap-6 overflow-hidden w-full">
            ...
            <div style={{ overflow: "hidden" }}>
              <h2 className="uppercase leading-tight" style={{ ...drukText, lineHeight: 1.05 }}>
                <span className="block" style={{ fontSize: "clamp(28px, 4vw, 56px)", color: "transparent", WebkitTextStroke: "2px #D85A30" }}>
                  STRENGTH
                </span>
                <span className="block" style={{ fontSize: "clamp(28px, 4vw, 56px)", color: "#fff" }}>
                  YOU CAN WEAR
                </span>
              </h2>
            </div>

            <p className="leading-relaxed" style={{ color: "rgba(255,255,255,0.7)", fontSize: "16px", maxWidth: "100%" }}>
